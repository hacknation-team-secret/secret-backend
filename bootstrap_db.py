...
def bootstrap():
    ...
    try:
        ...
        if not sf:
            ...
            sf = models.City(name="San Francisco", boundary=from_shape(sf_poly, srid=4326))
            db.add(sf)
        ...
        # 3. Create Vendors
        v1 = db.query(models.Vendor).filter(models.Vendor.name == "Bay Area Adventures").first()
        if not v1:
        ...
        v2 = db.query(models.Vendor).filter(models.Vendor.name == "NYC Urban Explorers").first()
        if not v2:
        ...
        events_data = [
            {
                ...
                "description": "Experience breathtaking views of the Golden Gate Bridge while parasailing.",
            ...
            },
            {
                ...
                "description": "A guided tour through the best dim sum spots in Chinatown.",
            ...
            },
            {
                ...
                "description": "Exclusive access to the sets of a major Broadway production.",
        ...
        for ed in events_data:
            existing = db.query(models.Event).filter(models.Event.title == ed["title"]).first()
            if not existing:
                ...
                event = models.Event(
                    ...
                    location=from_shape(ed["location"], srid=4326),
